...
def launch_setup(context, *args, **kwargs):
    ...
    """
    description_share = get_package_share_directory("pick_place_description")
    simulation_share = get_package_share_directory("pick_place_simulation")

    panda_urdf_xacro = os.path.join(
        description_share,
        "urdf",
        "panda.urdf.xacro",
    )
    ...
    simulation_share_parent = os.path.dirname(simulation_share)

    gz_resource_path = SetEnvironmentVariable(
        name="GZ_SIM_RESOURCE_PATH",
        value=":".join([
            description_share_parent,
            simulation_share_parent,
            description_share,
            simulation_share,
